...
if (isset($_POST['login'])) {
  ...
  if (mysqli_num_rows($query)>0) {
    ...
    if ($row['type'] != 1) {
        $_SESSION['standard']= $row['fname'];
        $_SESSION['accountnumber']=$row['accountnumber'];
        header('location: standardAccount.php');
    }
    else{
    ...
    $_SESSION['mssg']=" Incorrect Credentials";
    echo $_SESSION['mssg'];
    session_unset();
    ...
    <!-- Start Banner -->
        <div class="container mx-auto">
            ...
            <form action="" method='post' name="myForm">
              ...
              <div class="form-group row">
                <div class="col-sm-10">
                  <button type="submit" class="btn btn-primary" name="login">LogIn account</button>
                </div>
              </div>
            </form>      
            </div>
