        ...
        <div class="header_bottom">
          <div class="container">
            <div class="col-sm-12">
                ...
                <ul class="navbar-nav">
                        <li><a class="nav-link" href="accounts.php">Account</a></li>
                        <li><a class="nav-link" href="exchange.php">Exchange</a></li>
                        <li><a class="nav-link active" href="#contact">Contacts</a></li>
                    </ul>
                </div>
                     </div>
                 </nav>
                ...
                <div class="col-lg-12">
                    <div class="full paddding_left_10">
                        <div class="card card-outline card-primary">
                            ...
                            <h3 class="card-title">Feedbacks from Clients</h3>
                            </div>
                            <div class=" card-body ">
                                <div class="container">
                                            ...
                                            <div class="col-md-12">
                                                <div class="full">
                                                    <div class="heading_main text_align_center">
                                                            <h2><span class="theme_color"></span>Messages:</h2>    
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="container overflow-auto">
                                                    <table class="table table-hover table-striped"> 
                                                        ...
                                                        <?php
                                                            ...
                                                            $qry=mysqli_query($connection, "SELECT * FROM feedbacks ORDER BY messageId DESC");
                                                            ...
                                                            ?>  
                                                                <tr>
                                                                    ...
                                                                    <td align="center">
                                                                        <?php 
                                                                        include('replying.php');
                                                                        ?>
                                                
                                                                        <button class="btn btn-info"><a><span class="fa fa-edit text-primary"></span> <?php echo "<a href=\"$reply_link\">Reply</a>"; ?></a></button>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-12 offset-lg-3">
                    <div class="full">
                        <form class="contact_form_inner active" action="#contact" method="post" id="contact">
                            <fieldset>
                                <div class="field">
